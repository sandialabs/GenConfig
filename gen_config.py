...
class GenConfig(FormattedMsg):
    ...
    .. code-block:: ini
        ...
        [ATS1]
        # Insert ATS1 CMake configuration here

        [ATS1_MPI|YES]
        # Insert ATS1/MPI-enabled CMake configuration here

        # Complete configurations are mixed case
        [ats1_intel-19.0.4-mpich-7.7.15-hsw-openmp_mpi_serial_no-package-enables]
        use ATS1
        use ATS1_MPI|YES
